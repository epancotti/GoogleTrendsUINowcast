...
ggplot(weekly_UI_map, aes(x, y, group = group)) + 
  ...
  scale_fill_gradient2(high = "orangered3", na.value = "gray50") +
...
#####A BUNCH OF COMMENTED OUT STUFF REMOVE OR MOVE LATER
<!--
