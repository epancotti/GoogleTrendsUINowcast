...
Business and school closure orders and prohibitions on large-gatherings and dining-in at restaurants were spread across a three week period. While there is some variation in timing across weeks, there is much more variation across days. With normal initial unemployment insurance claims data, it would be difficult to identify what proportion of the increase in unemployment insurance claims is due to NPIs, like partial and complete closure orders, and what proportion is due to other policies or other pandemic-induced economic changes. 
...
partial_es <-felm(hits ~ days_factor | as.factor(location) | 0 | 0, 
...
complete_es <-felm(hits ~ days_factor | as.factor(location) | 0 | 0, 
